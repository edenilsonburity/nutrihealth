...
class Profissao { // Início da definição da classe/objeto "Profissao" — representa uma profissão de usuário
    ...
    public function __construct(?int $id,string $codigo,string $descricao_profissao){
     ...
     // Recebe: $id (pode ser null), $codigo e $descricao_profissao.
         $this->id=$id; $this->codigo=$codigo; $this->descricao_profissao=$descricao_profissao;
    ...
    public static function fromArray(array $d): self {
        ...
        // Cria e retorna um novo profissao usando os valores do array.
