  ...
  <div class="layout">
    <aside class="sidebar" id="sidebar">
      ...
      <?php
        ...
        $inProfissoes = $currentPage === 'indexProfissoes.php';
      ?>
      <nav class="nav-group">
       <a class="nav-item <?= !$inProfissoes ? 'active' : '' ?>" href="/nutrihealth/public/index.php"><i data-lucide="users"></i><span class="label">Usuários</span></a>
       <a class="nav-item <?= $inProfissoes ? 'active' : '' ?>" href="/nutrihealth/public/indexProfissoes.php"><i data-lucide="briefcase"></i><span class="label">Profissões</span></a>
