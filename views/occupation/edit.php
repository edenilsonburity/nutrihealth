...
<h2 style="margin-top:8px;margin-bottom:20px">Editar Profissão</h2>
...
<form method="post"
  ...
  <label style="display:block;margin-bottom:16px">
    ...
    <input
      ...
      value="<?= htmlspecialchars($occupation->code, ENT_QUOTES, 'UTF-8'); ?>"
  ...
  <label style="display:block;margin-bottom:20px">
    ...
    <input
      ...
      value="<?= htmlspecialchars($occupation->description, ENT_QUOTES, 'UTF-8'); ?>"
      style="width:100%;padding:10px 12px;border-radius:8px;
             border:1px solid var(--border);
             background:var(--surface-elev);color:var(--on-surface)"
    >
